...
Script to update v1.0.0 database to v2.0.0.
See <https://github.com/etrusci-org/hylandbook/releases> for release history.

Usage: update_v1.0.0_database_to_v2.0.0.py [PATH_TO_DATABASE_FILE]
'''
...
if __name__ == '__main__':
    try:
        ...
        if input("Do you want to update it to version 2.0.0 now? [y/n]: ").strip().lower() != 'y':
            _prompt_to_exit(0)
