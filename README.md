...
HYLANDBOOK is a command-line tool that watches your [Schedule I](https://scheduleonegame.com) save files and logs progress to a local [SQLite](https://sqlite.org) database.  
It can also automatically create/update export files with the current and history data whenever it detects changes in the save data - nifty for showing live stats in [OBS Studio](https://obsproject.com), for example.  
